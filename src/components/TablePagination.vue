    ...
    <div class="flex justify-between">
        ...
        <div class="pagination-controls flex items-center gap-[59px]">
            <div class="flex items-center gap-3">
                <span class="text-style-2 text-size-9 text-gray2">
                    Rows per page:
                </span>
                <div
            ...
            <div class="pagination-btns flex gap-[7px]">
                <button class="h-[26px] w-[26px] bg-[#0A1330] border-[#0B1739] p-1.5 rounded-[4px]" @click="prevPage"
                    :disabled="currentPage === 1">
                    <img src="../assets/commonIcons/arrow-r.png" alt="">
                </button>
                <button class="h-[26px] w-[26px] bg-[#0A1330] border-[#0B1739] p-1.5 rounded-[4px]" @click="nextPage"
